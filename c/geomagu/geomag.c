...
/*  COMPUTE ANNUAL CHANGE FOR X, Y, Z, AND H */
      ...
      printf("\n DEC         = %-7.2f DEG\t\t   DEC = %-6.2f  MIN/yr",dec1,adec);
      printf("\n DIP         = %-7.2f DEG\t\t   DIP = %-6.2f  MIN/yr",dip1,adip);
...
static void E0000(IENTRY,maxdeg,alt,glat,glon,time,dec,dip,ti,gv)

int IENTRY;
int *maxdeg;
float alt,glat,glon,time,*dec,*dip,*ti,*gv;
{
...
GEOMG1:
	...
	printf("\n CONTACT DMA FOR PRODUCT UPDATES:");
        printf("\n         DEFENSE MAPPING AGENCY");
        printf("\n         ATTN: CODE PRS");
        printf("\n         8613 LEE HIGHWAY");
        printf("\n         FAIRFAX, VA 22031-2137");
        printf("\n         (703)285-9197, AUTOVON 356-9197");
        printf("\n\n EPOCH  = %.3lf",epoch);
	printf("\n TIME   = %.3lf",time);
...
void geomg1(alt,glat,glon,time,dec,dip,ti,gv)
float alt,glat,glon,time,*dec,*dip,*ti,*gv;
{

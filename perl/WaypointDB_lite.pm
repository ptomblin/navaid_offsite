...
sub connectDB()
{
    ...
    $conn->func('concat', 2,
        sub { my ($a, $b) = @_; return $a . $b;}, 'create_function');
    $conn->func('now', 0,
        sub { return time;}, 'create_function');
    return ($conn, $conn);
}
...
#open(DEBUG,">>/config_backup/navaid.com/tmp/waypoint.out");
...
sub startGeneratorProcess($$$$$$$$$$$$$$$$$$$$$)
{
    ...
    my $tmpdir = "/config_backup/navaid.com/tmp/";
...
sub startGeneratorProcess2($$$$$$$$$$$$$$$$$$$$$)
{
    ...
    system("/config_backup/navaid.com/bin/respawn_something", @execargs);
}

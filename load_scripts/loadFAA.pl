...
my %FAA_chart_codes =
  ("AREA"                   =>  WaypointTypes::WPTYPE_RNAV,
   ...
   "GULF COAST VFR CHART"   =>  WaypointTypes::WPTYPE_VFR,
   ...
   "NOT REQUIRED"           =>  0,
   "WESTERN ATLANTIC ROUTE" =>  WaypointTypes::WPTYPE_HIGH_ENROUTE,
   "NORTH ATLANTIC ROUTE"   =>  WaypointTypes::WPTYPE_HIGH_ENROUTE,
   "NORTH PACIFIC ROUTE"    =>  WaypointTypes::WPTYPE_HIGH_ENROUTE,
   ...
   "SPECIAL DP"             =>  WaypointTypes::WPTYPE_APPROACH,
